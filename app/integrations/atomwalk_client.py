...
ATOMWALK_BASE_URL = os.getenv("ATOMWALK_BASE_URL")
ATOMWALK_DB_NAME = os.getenv("ATOMWALK_DB_NAME")
ATOMWALK_DEVICE_NO = os.getenv("ATOMWALK_DEVICE_NO")
