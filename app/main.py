...
from app.routes.sdk_heartbeat import router as sdk_heartbeat_router
from app.routes.sdk_register import router as sdk_register_router
...
app.include_router(sdk_heartbeat_router, prefix="/sdk")
app.include_router(sdk_register_router, prefix="/sdk")
@app.get("/")
def health():
